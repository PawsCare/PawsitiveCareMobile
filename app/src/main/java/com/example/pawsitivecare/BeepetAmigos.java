...
public class BeepetAmigos extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_beepet_amigos);
        ...
        lokasi.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String mapsUrl = "https://maps.app.goo.gl/5sQgUF8HajzWAWSx9"; // Contoh koordinat untuk Jakarta
                Intent intent = new Intent(Intent.ACTION_VIEW);
