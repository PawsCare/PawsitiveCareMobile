...
public class BeepetDaengta extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_beepet_daengta);
        ...
        lokasi.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String mapsUrl = "https://maps.app.goo.gl/g7DD62MamTtXh7YQ6"; // Contoh koordinat untuk Jakarta
                Intent intent = new Intent(Intent.ACTION_VIEW);
